...
public class AccountApp {
	public static void main(String[] args) throws FileNotFoundException {
		...
		int inMoney = 0; // 입금액
		int outMoney = 0; // 출금액
		File dir = new File("C:/Users/User/git/JavaSalesforce/thisisjava/src/ch18/problem02/");
		if (!dir.exists())
			dir.mkdir();
		...
		while (run) {
			try {
				...
				run2 = true;
				File f = new File(
						"C:/Users/User/git/JavaSalesforce/thisisjava/src/ch18/problem02/" + accNum + ".txt");
				if (!f.exists()) {
